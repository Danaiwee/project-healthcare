...
const HomePage = async () => {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between w-full min-h-screen px-4 sm:px-20">
      <div className="mt-10 md:mt-0 flex-1 flex flex-col gap-3 w-full">
        <div className="flex flex-col -space-y-5 md:-space-y-10">
          <h1 className="text-[50px] sm:text-[60px] md:text-[80px] font-bold text-sky-600">
            HEALTH
          </h1>
          <div className="flex items-center gap-4 ">
            ...
            <Image
              ...
              width={50}
              height={50}
              className="size-8 sm:size-10 md:size-15"
            />
          </div>
        </div>

        <p className="mt-2 sm:mt-4 text-sm sm:text-md md:text-lg text-gray-700">
          {message}
        </p>
      ...
      <div className="flex-2 md:flex items-center justify-center w-full">
        <Image
